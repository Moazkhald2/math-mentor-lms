  ...
  return (
    <div className="flex flex-col items-center pt-12 md:pt-24 text-center">
      ...
      <p className="mb-10 max-w-2xl text-lg leading-relaxed text-text-muted">
        ...
        Built for Grades 4–12 · because every student deserves{' '}
      ...
      <div className="mb-16 flex flex-col gap-4 sm:flex-row">
        ...
        <a
          href="/login"
          className="rounded-lg border-2 border-border px-8 py-3 font-semibold text-text-muted transition-colors hover:border-brand hover:text-text"
        >
          Sign In
        </a>
      </div>
      ...
      <div className="grid w-full gap-6 sm:grid-cols-3">
        {[
          ...
          },
          {
            icon: '🧩',
            title: 'Step-by-Step',
            desc: 'Full solutions with common-mistake breakdowns — clear & kind',
          ...
          <div
            key={card.title}
            className={`card-cute hover-lift p-6 text-left ${card.color}`}
          >
