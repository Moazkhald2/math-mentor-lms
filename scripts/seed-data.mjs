...
const questionBank = {
  ...
  7: [
    ...
    },
    {
      ...
      correct_answer: '1',
      explanation: 'P(red first) $= \\frac{4}{10} = \\frac{2}{5}$. After removing a red, 9 marbles left. P(white next) $= \\frac{3}{9} = \\frac{1}{3}$. Combined: $\\frac{2}{5} \\times \\frac{1}{3} = \\frac{2}{15}$.',
    },
  ],
  8: [
    {
